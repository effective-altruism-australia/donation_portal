...
async def test_specific_allocation_cancel_default_allocation_suggested_and_submit_with_standard_data():
    """
    ...
    async with async_playwright() as p:
        ...
        await page.get_by_text("$250").click()
        ...
        assert request_data["form-2-amount"] == "1.00"
