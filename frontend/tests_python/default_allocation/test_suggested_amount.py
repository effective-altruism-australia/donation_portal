...
async def test_default_allocation_submit_with_suggested_amount():
    """
    Ensure that the form sends the right data when you choose a suggested amount.
    """
    ...
    async with async_playwright() as p:
        ...
        assert request_data["form-1-amount"] == "5.00"
