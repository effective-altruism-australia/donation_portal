...
async def test_frequency_submit_one_time_donation_with_custom_amount():
    """
    Ensure that the form submits the correct data when a "one-time" frequency is
    selected (after toggling from "monthly").
    """
    ...
    async with async_playwright() as p:
        ...
        await page.get_by_text("One time").click()
