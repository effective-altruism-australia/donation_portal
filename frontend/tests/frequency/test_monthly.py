...
async def test_frequency_submit_monthly_donation_with_custom_amount():
    """
    ...
    async with async_playwright() as p:
        ...
        assert request_data["recurring_frequency"] == "monthly"
        assert request_data["recurring"] is True
