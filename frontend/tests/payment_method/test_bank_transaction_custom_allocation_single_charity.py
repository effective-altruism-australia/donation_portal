...
async def test_payment_method_submit_bank_transaction_donation_for_specific_charity():
    """
    ...
    async with async_playwright() as p:
        ...
        assert request_data["form-0-partner_charity"] == "give-directly"
        assert request_data["form-0-amount"] == "66"
        assert request_data["form-1-id"] is None
        assert request_data["form-1-partner_charity"] == "eaa-amplify"
        assert request_data["form-1-amount"] == "6.60"
