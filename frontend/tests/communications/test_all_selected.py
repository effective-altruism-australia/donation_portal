...
async def test_communications_all_checkboxes_selected():
    """
    Ensure that selecting all of the communications opt-in checkboxes
    works as expected.
    """
    ...
    async with async_playwright() as p:
        ...
        await (
            page.locator("label")
            .filter(has_text="Subscribe me to the global Effective")
            .locator("div")
            .click()
        )
        ...
        await (
            page.locator("label")
            .filter(has_text="Connect me with my local Effective")
            .locator("div")
            .click()
        )
        ...
        assert request_data["subscribe_to_newsletter"] is True
        assert request_data["connect_to_community"] is True
