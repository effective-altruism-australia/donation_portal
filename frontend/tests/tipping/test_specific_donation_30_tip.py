...
async def test_tipping_submit_specific_donation_with_30_percent_tip():
    """
    Ensure that the form submits the correct data when a specific donation is made with a 30% tip
    """
    ...
    async with async_playwright() as p:
        ...
        assert request_data["form-2-amount"] == "30.00"
