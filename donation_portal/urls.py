...
from donation.views.accounting import (
    accounting_reconciliation,
    donation_counter,
    accounting_reconciliation_eaae,
)
from donation.views.export import (
    render_export_page,
    download_spreadsheet,
    download_full_spreadsheet,
)
from donation.views.form_data import PartnerCharityView, ReferralSourceView
from donation.views.pledge import (
    stripe_webhooks_eaae,
    stripe_billing_portal_eaae,
    PledgeView,
    download_receipt,
    stripe_webhooks,
...
urlpatterns = [
    ...
    path(
        "eaae_accounting_reconciliation/",
        accounting_reconciliation_eaae,
        name="accounting-reconciliation-eaae",
    ),
    ...
    path(
        "download_full_spreadsheet/",
        download_full_spreadsheet,
        name="download-full-spreadsheet",
    ),
    ...
    path(
        "donor-portal/<path:customer_id>/",
        stripe_billing_portal,
        name="donor-portal-eaa",
    ),
    path(
        "donor-portal-eaae/<path:customer_id>/",
        stripe_billing_portal_eaae,
        name="donor-portal-eaae",
    ),
