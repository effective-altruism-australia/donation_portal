...
def create_pledge_components_for_existing_pledges(apps, schema_editor):
    ...
    for pledge in Pledge.objects.all():
        ...
        PledgeComponent.objects.create(pledge=pledge, partner_charity=pledge.recipient_org, amount=pledge.amount)
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(create_pledge_components_for_existing_pledges,
