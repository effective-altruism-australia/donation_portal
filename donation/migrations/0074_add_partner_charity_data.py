...
class Migration(migrations.Migration):
    ...
    def add_partner_charity_data(apps, schema_editor):
        ...
        for charity in json.loads(
            open(
                "donation/migrations/0074_charity_data.json", "r", encoding="utf-8"
            ).read()
        ):
    ...
    operations = [
        migrations.RunPython(
            add_partner_charity_data, reverse_code=add_partner_charity_data_reverse
        )
    ]
