...
def generate_xero_bank_data_for_tests():
    ...
    with open(os.path.join(settings.BASE_DIR, "donation/tests/data/bank_transactions.txt"), "wb") as myFile:
...
def generate_xero_trial_balance_data_for_test():
    ...
    with open(os.path.join(settings.BASE_DIR, "donation/tests/data/trial_balance.txt"), "wb") as myFile:
